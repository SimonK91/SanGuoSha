...
OBJECTS = main.cpp gameCard.o heroCard.o card.o Menu.o object_button.o object_slider.o object_text_box.o object_check_box.o functions.o object_window.o music.o SGS.o cardList.o
all: $(OBJECTS)
		@ echo
		@ echo execute skapas

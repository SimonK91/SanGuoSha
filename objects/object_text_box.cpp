...
bool text_box::set_font(const std::string& font_style, const unsigned& size)
{
	fontName = font_style;
	fontSize = size;
	TTF_Font* temp = nullptr;
	temp = TTF_OpenFont(fontName.c_str(), fontSize);
	if(temp == nullptr)
		return false;
	if(font != nullptr)
		clean_up({},{font});
...
bool text_box::set_font(const std::string& font_style)
{
	fontName = font_style;
	TTF_Font* temp = nullptr;
	temp = TTF_OpenFont(fontName.c_str(), fontSize);
...
bool text_box::set_font( const unsigned& size)
{
	fontSize = size;
	TTF_Font* temp = nullptr;
	temp = TTF_OpenFont(fontName.c_str(), fontSize);
